 ...
 */
trait ProductVariantFeeableTrait
{
    /**
     * @var FeeInterface[]|ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Positibe\Sylius\FeePlugin\Entity\Fee", mappedBy="variant", cascade={"persist", "remove"})
     */
    protected $fees;
    ...
    public function getVariantFees()
    {
        return $this->fees;
    }
